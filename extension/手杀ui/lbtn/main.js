app.import(function (lib, game, ui, get, ai, _status, app) {
	...
	/*-----------------分割线-----------------*/
		...
		var head = ui.create.node('div');
		head. innerText="房间号:"
		head.style.cssText="display: block; position: absolute; top: 86px; color: #F5D78E; right: 123px; font-size:20px; letter-spacing: 1.5px; font-family:shousha; font-weight: 900; text-shadow: #F5D78E 0 0 1px, black 0 0 2px, black 0 0 2px, black 0 0 2px, black 0 0 2px, black 0 0 2px, black 0 0 2px; -webkit-text-stroke:0px black !important; z-index:1; "
		document.body.appendChild(head);
		
		var head = ui.create.node('div');
		head. innerText=num=Math.floor(Math.random()*(999999-100000+1)+100000);
		head.style.cssText="display: block; position: absolute; top: 85px; right: 58px; font-size:21px; font-family:'shousha'; color: #F5D78E; font-weight: 900; text-shadow: #F5D78E 0 0 1px, black 0 0 2px, black 0 0 2px, black 0 0 2px, black 0 0 2px, black 0 0 2px, black 0 0 2px; -webkit-text-stroke:0px black !important; z-index:1"
		document.body.appendChild(head);
		...
		var head = ui.create.node('img');
		head.src= lib.assetURL + "extension/手杀ui/lbtn/images/zhengli.png"
